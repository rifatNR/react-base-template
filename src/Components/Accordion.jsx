...
const Accordion = ({accordion_type = "independent", customOnClick, className = '', isInitOpen = false, header = '', body = ''}) => {
    ...
    return (
        <div className={`text-md py-2  text-gray-800 ${className}`}>
            <div onClick={onClick} className={`flex justify-between items-center w-full cursor-pointer border-b ${isOpen && 'border-limadi'}`}>
