...
const Modal = ({show_modal, setShowModal, content, full_content}) => {
        ...
        <div>
            <Transition appear show={show_modal} as={Fragment}>
                <Dialog as="div" className="fixed inset-0 z-50 overflow-y-auto" onClose={modalOnClose}>
                    <div className="min-h-screen px-4 text-center backdrop-filter bg-gray-900 bg-opacity-30 backdrop-blur-sm font-poppins">
