        ...
        <aside className="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-indigo-500">
            ...
            <div className="sidebar-header flex items-center justify-center py-4">
                ...
                <a href="javascript/;" className="inline-flex flex-row items-center">
                    ...
                    <span className="leading-10 text-gray-100 text-2xl font-bold ml-1 uppercase">Brand name</span>
                </a>
                </div>
            </div>
        ...
        <main className="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
           ...
           {/* Header */}
            ...
            <footer className="footer px-4 py-6">
                ...
                <p className="text-sm text-gray-600 text-center">© Brand name 2020. All rights reserved. <a href="https://twitter.com/iaminos">by iAmine</a></p>
                </div>
            </footer>
        </main>
    </div>
